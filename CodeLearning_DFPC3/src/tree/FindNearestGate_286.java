...
public class FindNearestGate_286 
{
	...
	public int search(int[][] rooms, boolean[][]visited, int i, int j, int m, int n)
	{
		if(i<0 || i>=m || j<0 || j>=n || rooms[i][j]==-1) return Integer.MAX_VALUE;
		...
		//visited[i][j] = false;? I feel this line makes no sense here
